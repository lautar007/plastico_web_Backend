...
const publicControler = {
    ...
    putPublicacion: (req, res) =>{
        ...
        let editIndex = publicaciones.findIndex((el) => el.id === id);
        console.log(editIndex)

        publicaciones[editIndex] = {
            ...publicaciones[editIndex],
            titulo: req.body.titulo,
            fecha: req.body.fecha,
            contenido: req.body.contenido,
        ...
        res.send('Esto es la ruta de put para modificar una publicación!!')
    },
